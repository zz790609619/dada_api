package com.cx.dada.help;
import com.cx.dada.config.AppConfig;
import com.cx.dada.config.AppConstant;
import com.cx.dada.data.DadaApiResponse;
import com.cx.dada.service.BaseService;
import com.cx.dada.utils.HttpClientUtil;
import com.cx.dada.utils.JSONUtil;
...
public class DadaRequestClient {
    ...
    private String getRequestParams() {
        ...
        System.out.println("请求参数:"+JSONUtil.toJson(requestParams));
    ...
    private String getSign(Map<String, String> requestParams) {
        ...
        System.out.println("加密前:"+toSign);
        String sign = encrypt(toSign);
        System.out.println("加密后:"+sign.toUpperCase());
